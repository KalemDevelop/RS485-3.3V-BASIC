# Kalem-RS485-3.3V-Basic

Non-isolated 3.3 V RS-485 transceiver module based on **MAX3485**.  
...
- Supply voltage: **3.3 V** (typ. 3-3.6 V)
- MAX3485 half-duplex RS-485 transceiver
- **Non-isolated** module
...
|-----|------|--------------------------------------|
| 1   | 3.3V | Module supply voltage (3.3 V)         |
| 2   | B    | RS-485 B (–) line                    |
| 3   | A    | RS-485 A (+) line                    |
